...
module CollectionJson
  ...
  def collection
    { version: "1.0", #The collection object SHOULD have a version property.
      ...
      queries: queries, #The collection object MAY have an queries
                        #array child property.

      template: template, #The collection object MAY have an template object
                          #child property.
      #
